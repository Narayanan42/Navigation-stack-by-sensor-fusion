...
struct imu_msg_
{
  ...
  _MagField_type MagField;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _imu_string_type;
  _imu_string_type imu_string;
...
struct MD5Sum< ::imu_driver::imu_msg_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xf9d2e951f581dc78ULL;
  static const uint64_t static_value2 = 0x75d4036d9944fbf3ULL;
};
...
struct Printer< ::imu_driver::imu_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::imu_driver::imu_msg_<ContainerAllocator>& v)
  {
    ...
    s << indent << "imu_string: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.imu_string);
  }
};
