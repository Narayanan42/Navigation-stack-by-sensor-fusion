...
class imu_msg(genpy.Message):
  _md5sum = "f9d2e951f581dc7875d4036d9944fbf3"
...
MSG: sensor_msgs/MagneticField
 ...
 float64[9] magnetic_field_covariance # Row major about x, y, z axes
  ...
  __slots__ = ['Header','time','IMU','MagField','imu_string']
  _slot_types = ['std_msgs/Header','float64','sensor_msgs/Imu','sensor_msgs/MagneticField','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       Header,time,IMU,MagField,imu_string
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_d3I().pack(_x.time, _x.IMU.header.seq, _x.IMU.header.stamp.secs, _x.IMU.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time, _x.IMU.header.seq, _x.IMU.header.stamp.secs, _x.IMU.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.imu_string = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.imu_string = str[start:end]
      return self
